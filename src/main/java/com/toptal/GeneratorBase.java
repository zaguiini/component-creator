...
public abstract class GeneratorBase extends AnAction {
    ...
    private void runCommand(Project project, String command) throws IOException {
        TerminalView terminal = TerminalView.getInstance(project);

        ShellTerminalWidget shell = terminal.createLocalShellWidget(project.getBasePath(), "Davinci");
    ...
    public void actionPerformed(AnActionEvent event) {
        ...
        try {
            this.runCommand(project, this.getCommand(attributes));
